...
-- This file contains all the tables needed for the system
...
INSERT INTO students (user_id, first_name, last_name, email, phone, date_of_birth, address, enrollment_date)
VALUES (2, 'John', 'Doe', 'john.doe@school.com', '1234567890', '2000-05-15', '123 Main St', '2023-09-01');

INSERT INTO users (username, password, role, email) 
VALUES ('dr.smith', 'teach123', 'TEACHER', 'smith@school.com');

INSERT INTO teachers (user_id, first_name, last_name, email, phone, department, specialization, hire_date)
VALUES (3, 'Robert', 'Smith', 'smith@school.com', '9876543210', 'Computer Science', 'Data Structures', '2020-08-15');
